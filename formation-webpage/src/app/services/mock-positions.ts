...
export const OFFENSIVE_POSITIONS: Position[] = [
  { id: 0, name: 'Quarterback', abbreviatedName: 'QB', side: OFFENSE},
  { id: 1, name: 'Halfback', abbreviatedName: 'HB', side: OFFENSE},
  { id: 2, name: 'Fullback', abbreviatedName: 'FB', side: OFFENSE},
  { id: 3, name: 'Tight End', abbreviatedName: 'TE', side: OFFENSE},
  { id: 4, name: 'Tackle', abbreviatedName: 'OT', side: OFFENSE},
  { id: 5, name: 'Guard', abbreviatedName: 'G', side: OFFENSE},
  { id: 6, name: 'Center', abbreviatedName: 'C', side: OFFENSE},
  { id: 7, name: 'Wide Reciever', abbreviatedName: 'WR', side: OFFENSE},
];
